...
from aes_xor_fhe.xor_service import XORService, EngineWrapper, XORConfig, CoefficientCache, ZetaEncoder
...
def xor_svc():
    ...
    svc = XORService(eng, coeff_cache=coeff_cache, nibble_hi_path=hi_cache, nibble_lo_path=lo_cache)
    return svc
